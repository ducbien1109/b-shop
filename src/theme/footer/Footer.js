  ...
  return (
    <footer>
      <div className="footer">
          ...
          <div className="footer-content">
            <div className="row">
              <div className="col-4 pl-20" style={{ width: "45%" }}>
                ...
                <h4
                  className="title-menu position-relative mt-30"
                  style={{ fontSize: "16px" }}
                >
                  {FOOTER.TITLE_1}
                </h4>
              ...
              <div className="col-4 pl-20" style={{ width: "30%" }}>
                <h4
                  className="title-menu position-relative mt-30"
                  style={{ fontSize: "16px", marginTop: "65px" }}
                >
                  {FOOTER.TITLE_2}
                </h4>
                <div
                ...
                <ul className="list-menu">
                  <li className="fone d-flex">
                    <div
                      className="icon-footer d-flex align-items-center"
                      style={{ width: "23px", paddingLeft: "2px" }}
                    >
                      <img
                        src={phone}
                        width="15"
                    ...
                    <span style={{ fontWeight: "500", marginLeft: "5px" }}>
                      {FOOTER.HOTLINE_TXT} {storeInfo.hotline}
                    </span>
                  </li>
                  <li className="fone d-flex">
                    <div
                  ...
                  <li className="fone d-flex">
                    ...
                    <span style={{ fontWeight: "500", marginLeft: "5px" }}>
                      {FOOTER.EMAIL_TXT} {storeInfo.email}
                    </span>
                  </li>
                  <li className="fone d-flex">
                    <div
                    ...
                    <span style={{ fontWeight: "500", marginLeft: "5px" }}>
                      {FOOTER.OPENING_HOURS_TXT} {storeInfo.openingHours} -{" "}
        ...
        <div className="copyright w-100 text-center">{FOOTER.DEVELOPED_BY}</div>
      </div>
    </footer>
  );
};
